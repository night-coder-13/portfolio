<template>
        <div id="about" class="flex flex-col items-center justify-center h-full w-full relative">
            ...
            <div class="absolute bottom-0 text-green grid justify-items-center">
                <Typewriter class="text-sm " text="با من بیشتر آشنا شو" />
                <div class="mt-3">
                    <svg ref="iconScroll" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
