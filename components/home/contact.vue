        ...
        <div class="w-full pt-10 p-2 sm:p-8">
            <div class="flex flex-col md:flex-row py-8 md:px-4">
                ...
                <div class="w-full md:w-2/4 grid h-full content-center gap-2 justify-items-center pb-8">
                    ...
                    <h5 class="text-center text-2xl ext-gray-200 mt-4 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-phone mx-2 text-green">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path
                    ...
                    <p class="text-center text-lg text-green font-bold mt-2">0993-179-9332 | 0990-277-4517</p>
                </div>
            </div>
        </div>
        <hr class="w-full">
        <p class="text-center Iran-yekan text-sm my-2">{ بهترین سرمایه انسان، دانش اوست }</p>
    </div>
</template>
<script setup>
